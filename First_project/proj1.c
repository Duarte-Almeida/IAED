/*
 * Ficheiro: proj_final.c
 * Autor: Duarte Calado de Almeida, N.95565, LEIC-A
 * Descricao: Sistema de logistica que permite gerir um inventario de produtos
 * e um conjunto de encomendas.
*/
