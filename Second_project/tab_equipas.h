/*
 * Ficheiro: tab_equipas.h
 * Autor: Duarte Calado de Almeida, n.95565
 * Descricao: Prototipos de funcoes de adaptacao da tabela de dispersao ao
 * tipo 'equipa' e outras que manipulam listas e tabelas de dispersao unicamente
 * quando comportam este tipo
 */
